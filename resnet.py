...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.inplanes = 64
        self.dilation = 1
        self.emb_sz = 512 * block.expansion
        ...
        # self.conv1 = ChrisConv(3, self.inplanes, 7, stride=2, padding=3, bias=False)
...
class MetaResNet(nn.Module):
    def __init__(self, resnet, hidden_sz=128, dropout=0.7):
        super(MetaResNet, self).__init__()

        self.fc1 = nn.Linear(29, hidden_sz)
        ...
        self.resnet = resnet
        self.emb_sz = self.resnet.emb_sz
        self.classifier = nn.Linear(self.emb_sz + hidden_sz, 1)
...
class ChipNet(nn.Module):
    def __init__(self, resnet, attn_hidden=512, emb_dropout=0.5, attn_dropout=0.7):
        ...
        self.attn_fc1 = nn.Conv2d(self.emb_sz, attn_hidden, kernel_size=3, padding=1)
        self.attn_fc2 = nn.Conv2d(attn_hidden, 1, kernel_size=3, padding=1)

        self.attn_bn1 = nn.BatchNorm2d(attn_hidden)
         
        self.bn4 = nn.BatchNorm1d(self.emb_sz)
        self.fc4 = nn.Linear(self.emb_sz, 1)
